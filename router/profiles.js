...
router.get('/v1/profiles', controller.profilesV1.get)
router.get('/v1/profiles/:id', controller.profilesV1.getById)
router.put('/v1/profiles/:id', controller.profilesV1.update)
router.post('/v1/profiles', controller.profilesV1.create)
router.delete('/v1/profiles/:id', controller.profilesV1.destroy)
